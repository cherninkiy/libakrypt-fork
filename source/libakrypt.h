...
/* ----------------------------------------------------------------------------------------------- */
/** \defgroup mac-doc Методы обеспечения целостности данных (хеширование и имитозащита)
 @{                                                                                                */
...
/*! @brief Контекст бесключевой функции хеширования.
    @details Класс предоставляет интерфейс для реализации бесключевых функций хеширования,
    построенных с использованием итеративных сжимающих отображений. В настоящее время
    с помощью класса @ref hash реализованы следующие отечественные алгоритмы хеширования
     - Стрибог256,
     - Стрибог512,
