...
могут применяться различные алгоритмы:
  ...
  -  режим ``omac-acpkm``, основанный на применении алгоритмов блочного шифрования (см. Р 1323565.1.017—2018).
...
3. Для использования алгоритма ``omac-acpkm``необходимо воспользоваться следующей функцией:

 - :func:`int ak_bckey_omac_acpkm`.
