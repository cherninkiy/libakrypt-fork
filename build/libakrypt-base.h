...
/* #undef AK_HAVE_BYTESWAP_H */
#ifdef AK_HAVE_BYTESWAP_H
 #include <byteswap.h>
#endif

/* #undef AK_HAVE_STDALIGN_H */
#ifdef AK_HAVE_STDALIGN_H
 #include <stdalign.h>
#endif

/* #undef AK_HAVE_TIME_H */
#ifdef AK_HAVE_TIME_H
 #include <time.h>
#endif

/* #undef AK_HAVE_SYSMMAN_H */
#ifdef AK_HAVE_SYSMMAN_H
 #include <sys/mman.h>
#endif

/* #undef AK_HAVE_SYSTYPES_H */
#ifdef AK_HAVE_SYSTYPES_H
 #include <sys/types.h>
#endif

/* ----------------------------------------------------------------------------------------------- */
/* #undef AK_HAVE_ERRNO_H */
/* #undef AK_HAVE_STRINGS_H */
/* #undef AK_HAVE_ENDIAN_H */
/* #undef AK_HAVE_SYSTIME_H */
/* #undef AK_HAVE_SYSLOG_H */
/* #undef AK_HAVE_UNISTD_H */
/* #undef AK_HAVE_FCNTL_H */
/* #undef AK_HAVE_LIMITS_H */
/* #undef AK_HAVE_SYSSTAT_H */
/* #undef AK_HAVE_SYSSOCKET_H */
/* #undef AK_HAVE_SYSUN_H */
/* #undef AK_HAVE_SYSSELECT_H */
/* #undef AK_HAVE_TERMIOS_H */
/* #undef AK_HAVE_DIRENT_H */
/* #undef AK_HAVE_FNMATCH_H */
/* #undef AK_HAVE_LOCALE_H */
/* #undef AK_HAVE_SIGNAL_H */
/* #undef AK_HAVE_GETOPT_H */
