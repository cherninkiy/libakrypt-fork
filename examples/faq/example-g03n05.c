...
int main(int argc, char* argv[]){
    ...
    unsigned char cipher_text[16]={0x69, 0xcc, 0xa1, 0xc9, 0x35, 0x57, 0xc9, 0xe3,
    ...
    ak_bckey_encrypt_ecb(&ctx,&plain_text,&out,inlen);
    ...
    ak_bckey_decrypt_ecb(&ctx,&out,&in,inlen);
