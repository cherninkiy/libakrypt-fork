...
int main(int argc, char* argv[]){
    ...
    unsigned char cipher_text[16]={0xc3, 0x1e, 0x49, 0x0a, 0x90, 0xef, 0xa3, 0x74,
    ...
    ak_bckey_encrypt_ofb(&ctx,&plain_text,&out,inlen,&sync_p,16);
    ...
    ak_bckey_decrypt_cfb(&ctx,&out,&in,inlen,&sync_p,16);
