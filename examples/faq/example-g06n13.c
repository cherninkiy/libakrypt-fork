/* --------------------------------------------------------------------------------- */
/* Пример example-g06n13.c                                                           */ 
/*                                                                                   */
/* Простейшая иллюстрация вызова функции ak_wcurve_is_ok()                           */
/* --------------------------------------------------------------------------------- */
...
int main( void ) {
  ...
  /* проверяем корректность параметров эллиптической кривой*/
  printf("Проверка параметров: %d\n", ak_wcurve_is_ok(&mycurve));
